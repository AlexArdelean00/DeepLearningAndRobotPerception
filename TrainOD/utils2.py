...
def download_and_convert(data_root):
    ...
    imagePathsWithBB = glob.glob(os.path.join(data_root, "images", "*.jpg"))
    ...
    trainingImagePaths = glob.glob(os.path.join("../TrainBackbone/.data/pet/train/cat", "*.jpg"))\
          + glob.glob(os.path.join("../TrainBackbone/.data/pet/train/cat", "*.jpg")) 
    testImagePaths = glob.glob(os.path.join("../TrainBackbone/.data/pet/test/cat", "*.jpg"))\
          + glob.glob(os.path.join("../TrainBackbone/.data/pet/test/cat", "*.jpg")) 

    # prepare a training data
    for path in trainingImagePaths:
        if path in imagePathsWithBB:
